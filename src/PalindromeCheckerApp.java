...
public class PalindromeCheckerApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("UC5 Result: " + (input.equals(reversedStack) ? "Palindrome (Stack)" : "NOT Palindrome (Stack)"));
        ...
        String cleaned = originalInput.toLowerCase().replaceAll("[^a-z0-9]", "");
        ...
        System.out.println("UC10 Result: " + (isPalindromeUC10 ?
                "Palindrome (Ignore spaces & case)" :
                "NOT Palindrome (Ignore spaces & case)"));
